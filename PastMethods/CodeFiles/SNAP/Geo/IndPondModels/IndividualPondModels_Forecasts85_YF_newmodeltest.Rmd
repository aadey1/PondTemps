...
# Save the plot
ggsave("Output/GeoSNAP/YF_PondTemp.png", plot = YF_PondTemp, width = 8, height = 6)
...
data$muAirTemp <- YF_AirTemp$Air_MonthAvg
# Air temperature precision
data$tauAirTemp <- YF_AirTemp$precision
```
...
MP1_out_params <- coda.samples(model = jm,
...
MP1_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(MP1_out_params)
gelman.diag(MP1_out_params, confidence = 0.99)
```
...
time <-as.Date(time)
out <- as.matrix(MP1_out_response)         ## convert from coda to matrix
...
# changing ci to a dataframe so that it can be plotted
  ...
  MP1_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
MP1ModelPlot <- ggplot(MP1_OutputCheck) +
...
MP1ModelErrorPlot <- ggplot(MP1_OutputCheck, mapping = aes(date)) +
...
ggsave("Output/GeoSNAP/MP1_85_ModelPlot.jpeg", plot = MP1ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP1_85_ModelErrorPlot.jpeg", plot = MP1ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP1Mod <- MP1_OutputCheck
write.csv(MP1Mod, file = "MP1Mod_85.csv", row.names = F)

MP1_NSE <- NSE(MP1Mod$`50%`, MP1_OutputCheck$MP1, na.rm = TRUE)
MP1_NSE
...
ggsave("Output/GeoSNAP/MP1_ObsModelPlot_85.jpeg", plot = MP1ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/MP1_2030_85_ModelPlot.jpeg", plot = MP1_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP1_2030_85_ModelErrorPlot.jpeg", plot = MP1_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/GeoSNAP/MP1_2060_85_ModelPlot.jpeg", plot = MP1_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP1_2060_85_ModelErrorPlot.jpeg", plot = MP1_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/GeoSNAP/MP1_2090_85_ModelPlot.jpeg", plot = MP1_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP1_2090_85_ModelErrorPlot.jpeg", plot = MP1_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
MP3_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
MP3_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(MP3_out_params)
gelman.diag(MP3_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(MP3_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  MP3_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
MP3ModelPlot <- ggplot(MP3_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
MP3ModelErrorPlot <- ggplot(MP3_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
  geom_ribbon(mapping = aes(ymin = `2.5%`, ymax = `97.5%`), fill = "#377EB8") +
  geom_line(aes(x = date, y = `50%`), color = "black") +
  geom_point(aes(x = date, y = MP3)) +
  geom_vline(xintercept = as.Date("2021-01-01"), color = "red", linetype = "dashed", size = 1) +
  ylim(c(-10, 30))+
...
ggsave("Output/GeoSNAP/MP3_85_ModelPlot.jpeg", plot = MP3ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP3_85_ModelErrorPlot.jpeg", plot = MP3ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP3Mod <- MP3_OutputCheck
write.csv(MP3Mod, file = "MP3Mod_85.csv", row.names = F)

MP3_NSE <- NSE(MP3Mod$`50%`, MP3_OutputCheck$MP3, na.rm = TRUE)
MP3_NSE
...
ggsave("Output/GeoSNAP/MP3_ObsModelPlot_85.jpeg", plot = MP3ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/MP3_2030_85_ModelPlot.jpeg", plot = MP3_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP3_2030_85_ModelErrorPlot.jpeg", plot = MP3_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
MP3_2060 <- MP3_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/MP3_2060_85_ModelPlot.jpeg", plot = MP3_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP3_2060_85_ModelErrorPlot.jpeg", plot = MP3_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
MP3_2090 <- MP3_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/MP3_2090_85_ModelPlot.jpeg", plot = MP3_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP3_2090_85_ModelErrorPlot.jpeg", plot = MP3_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
MP5_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
MP5_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(MP5_out_params)
gelman.diag(MP5_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(MP5_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  MP5_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
MP5ModelPlot <- ggplot(MP5_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
MP5ModelErrorPlot <- ggplot(MP5_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/MP5_85_ModelPlot.jpeg", plot = MP5ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP5_85_ModelErrorPlot.jpeg", plot = MP5ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP5Mod <- MP5_OutputCheck
write.csv(MP5Mod, file = "MP5Mod_85.csv", row.names = F)

MP5_NSE <- NSE(MP5Mod$`50%`, MP5_OutputCheck$MP5, na.rm = TRUE)
MP5_NSE
...
ggsave("Output/GeoSNAP/MP5_ObsModelPlot_85.jpeg", plot = MP5ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/MP5_2030_85_ModelPlot.jpeg", plot = MP5_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP5_2030_85_ModelErrorPlot.jpeg", plot = MP5_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
MP5_2060 <- MP5_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/MP5_2060_85_ModelPlot.jpeg", plot = MP5_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP5_2060_85_ModelErrorPlot.jpeg", plot = MP5_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
MP5_2090 <- MP5_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/MP5_2090_85_ModelPlot.jpeg", plot = MP5_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP5_2090_85_ModelErrorPlot.jpeg", plot = MP5_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
MP8_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
MP8_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(MP8_out_params)
gelman.diag(MP8_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(MP8_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  MP8_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
MP8ModelPlot <- ggplot(MP8_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
MP8ModelErrorPlot <- ggplot(MP8_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/MP8_85_ModelPlot.jpeg", plot = MP8ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP8_85_ModelErrorPlot.jpeg", plot = MP8ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP8Mod <- MP8_OutputCheck
write.csv(MP8Mod, file = "MP8Mod_85.csv", row.names = F)

MP8_NSE <- NSE(MP8Mod$`50%`, MP8_OutputCheck$MP8, na.rm = TRUE)
MP8_NSE
...
ggsave("Output/GeoSNAP/MP8_ObsModelPlot_85.jpeg", plot = MP8ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/MP8_2030_85_ModelPlot.jpeg", plot = MP8_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP8_2030_85_ModelErrorPlot.jpeg", plot = MP8_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
MP8_2060 <- MP8_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/MP8_2060_85_ModelPlot.jpeg", plot = MP8_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP8_2060_85_ModelErrorPlot.jpeg", plot = MP8_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
MP8_2090 <- MP8_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/MP8_2090_85_ModelPlot.jpeg", plot = MP8_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/MP8_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
PL1_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
PL1_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(PL1_out_params)
gelman.diag(PL1_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(PL1_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  PL1_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
PL1ModelPlot <- ggplot(PL1_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
PL1ModelErrorPlot <- ggplot(PL1_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/PL1_85_ModelPlot.jpeg", plot = PL1ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL1_85_ModelErrorPlot.jpeg", plot = PL1ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
PL1Mod <- PL1_OutputCheck
write.csv(PL1Mod, file = "PL1Mod_85.csv", row.names = F)

PL1_NSE <- NSE(PL1Mod$`50%`, PL1_OutputCheck$PL1, na.rm = TRUE)
PL1_NSE
...
ggsave("Output/GeoSNAP/PL1_ObsModelPlot_85.jpeg", plot = PL1ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/PL1_2030_85_ModelPlot.jpeg", plot = PL1_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL1_2030_85_ModelErrorPlot.jpeg", plot = PL1_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
PL1_2060 <- PL1_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/PL1_2060_85_ModelPlot.jpeg", plot = PL1_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL1_2060_85_ModelErrorPlot.jpeg", plot = PL1_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
PL1_2090 <- PL1_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/PL1_2090_85_ModelPlot.jpeg", plot = PL1_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL1_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
PL2_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
PL2_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(PL2_out_params)
gelman.diag(PL2_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(PL2_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  PL2_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
PL2ModelPlot <- ggplot(PL2_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
PL2ModelErrorPlot <- ggplot(PL2_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/PL2_85_ModelPlot.jpeg", plot = PL2ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL2_85_ModelErrorPlot.jpeg", plot = PL2ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
PL2Mod <- PL2_OutputCheck
write.csv(PL2Mod, file = "PL2Mod_85.csv", row.names = F)

PL2_NSE <- NSE(PL2Mod$`50%`, PL2_OutputCheck$PL2, na.rm = TRUE)
PL2_NSE
...
ggsave("Output/GeoSNAP/PL2_ObsModelPlot_85.jpeg", plot = PL2ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/PL2_2030_85_ModelPlot.jpeg", plot = PL2_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL2_2030_85_ModelErrorPlot.jpeg", plot = PL2_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
PL2_2060 <- PL2_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/PL2_2060_85_ModelPlot.jpeg", plot = PL2_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL2_2060_85_ModelErrorPlot.jpeg", plot = PL2_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
PL2_2090 <- PL2_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/PL2_2090_85_ModelPlot.jpeg", plot = PL2_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL2_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
PL3_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
PL3_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(PL3_out_params)
gelman.diag(PL3_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(PL3_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  PL3_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
PL3ModelPlot <- ggplot(PL3_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
PL3ModelErrorPlot <- ggplot(PL3_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/PL3_85_ModelPlot.jpeg", plot = PL3ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL3_85_ModelErrorPlot.jpeg", plot = PL3ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
PL3Mod <- PL3_OutputCheck
write.csv(PL3Mod, file = "PL3Mod_85.csv", row.names = F)

PL3_NSE <- NSE(PL3Mod$`50%`, PL3_OutputCheck$PL3, na.rm = TRUE)
PL3_NSE
...
ggsave("Output/GeoSNAP/PL3_ObsModelPlot_85.jpeg", plot = PL3ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/PL3_2030_85_ModelPlot.jpeg", plot = PL3_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL3_2030_85_ModelErrorPlot.jpeg", plot = PL3_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
PL3_2060 <- PL3_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/PL3_2060_85_ModelPlot.jpeg", plot = PL3_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL3_2060_85_ModelErrorPlot.jpeg", plot = PL3_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
PL3_2090 <- PL3_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/PL3_2090_85_ModelPlot.jpeg", plot = PL3_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/PL3_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
UBP1_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
UBP1_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(UBP1_out_params)
gelman.diag(UBP1_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(UBP1_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  UBP1_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
UBP1ModelPlot <- ggplot(UBP1_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
UBP1ModelErrorPlot <- ggplot(UBP1_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/UBP1_85_ModelPlot.jpeg", plot = UBP1ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP1_85_ModelErrorPlot.jpeg", plot = UBP1ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP1Mod <- UBP1_OutputCheck
write.csv(UBP1Mod, file = "UBP1Mod_85.csv", row.names = F)

UBP1_NSE <- NSE(UBP1Mod$`50%`, UBP1_OutputCheck$UBP1, na.rm = TRUE)
UBP1_NSE
...
ggsave("Output/GeoSNAP/UBP1_ObsModelPlot_85.jpeg", plot = UBP1ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/UBP1_2030_85_ModelPlot.jpeg", plot = UBP1_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP1_2030_85_ModelErrorPlot.jpeg", plot = UBP1_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
UBP1_2060 <- UBP1_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/UBP1_2060_85_ModelPlot.jpeg", plot = UBP1_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP1_2060_85_ModelErrorPlot.jpeg", plot = UBP1_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
UBP1_2090 <- UBP1_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/UBP1_2090_85_ModelPlot.jpeg", plot = UBP1_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP1_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
UBP2_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
UBP2_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(UBP2_out_params)
gelman.diag(UBP2_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(UBP2_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  UBP2_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
UBP2ModelPlot <- ggplot(UBP2_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
UBP2ModelErrorPlot <- ggplot(UBP2_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
...
ggsave("Output/GeoSNAP/UBP2_85_ModelPlot.jpeg", plot = UBP2ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP2_85_ModelErrorPlot.jpeg", plot = UBP2ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP2Mod <- UBP2_OutputCheck
write.csv(UBP2Mod, file = "UBP2Mod_85.csv", row.names = F)

UBP2_NSE <- NSE(UBP2Mod$`50%`, UBP2_OutputCheck$UBP2, na.rm = TRUE)
UBP2_NSE
...
ggsave("Output/GeoSNAP/UBP2_ObsModelPlot_85.jpeg", plot = UBP2ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/UBP2_2030_85_ModelPlot.jpeg", plot = UBP2_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP2_2030_85_ModelErrorPlot.jpeg", plot = UBP2_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
UBP2_2060 <- UBP2_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/UBP2_2060_85_ModelPlot.jpeg", plot = UBP2_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP2_2060_85_ModelErrorPlot.jpeg", plot = UBP2_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
UBP2_2090 <- UBP2_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/UBP2_2090_85_ModelPlot.jpeg", plot = UBP2_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP2_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
UBP3_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
UBP3_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(UBP3_out_params)
gelman.diag(UBP3_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(UBP3_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  UBP3_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
UBP3ModelPlot <- ggplot(UBP3_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
UBP3ModelErrorPlot <- ggplot(UBP3_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
  geom_ribbon(mapping = aes(ymin = `2.5%`, ymax = `97.5%`), fill = "lightgreen") +
  geom_line(aes(x = date, y = `50%`), color = "black") +
  geom_point(aes(x = date, y = UBP3)) +
  geom_vline(xintercept = as.Date("2021-01-01"), color = "red", linetype = "dashed", size = 1) +
  ylim(c(-10, 30))+
...
ggsave("Output/GeoSNAP/UBP3_85_ModelPlot.jpeg", plot = UBP3ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP3_85_ModelErrorPlot.jpeg", plot = UBP3ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP3Mod <- UBP3_OutputCheck
write.csv(UBP3Mod, file = "UBP3Mod_85.csv", row.names = F)

UBP3_NSE <- NSE(UBP3Mod$`50%`, UBP3_OutputCheck$UBP3, na.rm = TRUE)
UBP3_NSE
...
ggsave("Output/GeoSNAP/UBP3_ObsModelPlot_85.jpeg", plot = UBP3ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/UBP3_2030_85_ModelPlot.jpeg", plot = UBP3_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP3_2030_85_ModelErrorPlot.jpeg", plot = UBP3_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
UBP3_2060 <- UBP3_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/UBP3_2060_85_ModelPlot.jpeg", plot = UBP3_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP3_2060_85_ModelErrorPlot.jpeg", plot = UBP3_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
UBP3_2090 <- UBP3_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/UBP3_2090_85_ModelPlot.jpeg", plot = UBP3_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP3_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
```{r}
# Posterior samples of parameters
UBP4_out_params <- coda.samples(model = jm,
                               variable.names = c('beta',
                                                  'tau_add', 'tau_obs'),
                               n.iter = 100000, thin = 5)
```
...
```{r}
# Posterior samples of response variables
UBP4_out_response <- coda.samples(model = jm,
                                 variable.names = c('x', 'OBS'),
                                 n.iter = 100000, thin = 5)

plot(UBP4_out_params)
gelman.diag(UBP4_out_params, confidence = 0.99)
```
...
time                               ## adjust to zoom in and out
time <-as.Date(time)
out <- as.matrix(UBP4_out_response)         ## convert from coda to matrix
x.cols <- grep("^x",colnames(out)) ## grab all columns that start with the letter x
ci <- apply(out[,x.cols], 2, quantile, c(0.025,0.5,0.975))
...
# changing ci to a dataframe so that it can be plotted
  ...
  UBP4_OutputCheck <- merge(ModelOutput, YF_WaterTemp, by = "date", all = T)

# Now you can use this data frame with ggplot2
UBP4ModelPlot <- ggplot(UBP4_OutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
UBP4ModelErrorPlot <- ggplot(UBP4_OutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
  geom_ribbon(mapping = aes(ymin = `2.5%`, ymax = `97.5%`), fill = "#6A3D9A") +
  geom_line(aes(x = date, y = `50%`), color = "black") +
  geom_point(aes(x = date, y = UBP4)) +
  geom_vline(xintercept = as.Date("2021-01-01"), color = "red", linetype = "dashed", size = 1) +
  ylim(c(-10, 30))+
...
ggsave("Output/GeoSNAP/UBP4_85_ModelPlot.jpeg", plot = UBP4ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP4_85_ModelErrorPlot.jpeg", plot = UBP4ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP4Mod <- UBP4_OutputCheck
write.csv(UBP4Mod, file = "UBP4Mod_85.csv", row.names = F)

UBP4_NSE <- NSE(UBP4Mod$`50%`, UBP4_OutputCheck$UBP4, na.rm = TRUE)
UBP4_NSE
...
ggsave("Output/GeoSNAP/UBP4_ObsModelPlot_85.jpeg", plot = UBP4ModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/GeoSNAP/UBP4_2030_85_ModelPlot.jpeg", plot = UBP4_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP4_2030_85_ModelErrorPlot.jpeg", plot = UBP4_2030_ModelErrorPlot, width = 8, height = 6)
```

2. 2060s
```{r}
# filtering for 2030s
UBP4_2060 <- UBP4_OutputCheck %>%
  filter(date > "2059-12-01" & date < "2070-01-01")
...
ggsave("Output/GeoSNAP/UBP4_2060_85_ModelPlot.jpeg", plot = UBP4_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP4_2060_85_ModelErrorPlot.jpeg", plot = UBP4_2060_ModelErrorPlot, width = 8, height = 6)
```

3. 2090s
```{r}
# filtering for 2030s
UBP4_2090 <- UBP4_OutputCheck %>%
  filter(date > "2089-12-01" & date < "2100-01-01")
...
ggsave("Output/GeoSNAP/UBP4_2090_85_ModelPlot.jpeg", plot = UBP4_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/GeoSNAP/UBP4_2090_85_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/GeoSNAP/YF_85_Mean.jpeg", plot = YF_85_Mean, width = 9, height = 6)
```
...
ggsave("Output/GeoSNAP/IndPonds_Full_YF85.jpeg", plot = IndPonds_Full_YF85, width = 9, height = 6)
...
ggsave("Output/GeoSNAP/IndPonds_YF85.jpeg", plot = IndPonds_YF85, width = 9, height = 6)
