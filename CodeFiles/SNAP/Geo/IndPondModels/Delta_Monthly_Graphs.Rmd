...
MonthlyStatsCRD
ggsave("Output/GeoSNAP/DeltaMonthCRD.png", plot = MonthlyStatsCRD, width = 12, height = 3)
```
...
MonthlyStatsYF
ggsave("Output/GeoSNAP/DeltaMonthYF.png", plot = MonthlyStatsYF, width = 12, height = 3)
```
