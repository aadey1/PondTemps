...
BVSModelErrorPlot <- ggplot(BVSMod, mapping = aes(date)) +
  ...
  annotate("text", x = as.Date("2020-01-01"), y = 25, label = "NSE = 0.928")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/IndPonds_Full_CR45.jpeg", plot = IndPonds_Full_CR45, width = 9, height = 6)
...
ggsave("Output/SNAP/OriginalModel/Rerun/IndPonds_CR45.jpeg", plot = IndPonds_CR45, width = 9, height = 6)
