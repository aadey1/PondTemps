...
```{r}
CR_Temps <- read.csv("DataFiles/CopperRiver_CreatedFiles/CR_45SNAPForecast.csv", header=TRUE)
...
```{r}
CR_AirTemp <- CR_Temps %>%
  select(date, Airport, Air_MonthAvg, Air_MonthMax, Air_MonthMin, Region)
...
CR_Temps_long <- CR_Temps %>%
  pivot_longer(cols = c(Air_MonthAvg, Air_MonthMax, Air_MonthMin, BVS, CAB, TIN, SQR, CAN, EYS, TIS, WDD, RHM),
               names_to = "variable",
               values_to = "value")
...
CR_PondTemp <- ggplot(CR_Temps_long, aes(x = as.Date(date), y = value, color = variable)) +
  ...
  geom_line(data = filter(CR_Temps_long, variable != "Air_MonthAvg", variable != "Air_MonthMax", variable !="Air_MonthMin")) +  
...
# Save the plot
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CR_PondTemp.png", plot = CR_PondTemp, width = 8, height = 6)

```

# Starting the Analysis

## Setting up the temperature data for the random walk models witht he uniform error from min to max temp
```{r}
# Getting the max and min temperatures to set up the model for the SNAP data to pull from the uniform distribution from min to max -- goal is to increase the amount of error here

#start by comparing the range of temps for the three decadal periods?
TempObs <-  CR_AirTemp %>%
...
MaxTemp = CR_AirTemp$Air_MonthMax

MinTemp = CR_AirTemp$Air_MonthMin

initialTemp <- CR_AirTemp[1,]
meanTemp = initialTemp$Air_MonthAvg
meanTemp
stdTemp = (initialTemp$Air_MonthMax - initialTemp$Air_MonthMin)/4
stdTemp
...
model{
  ...
  for(t in 2:n){
    ...
    temp[t] ~ dunif(MinTemp[t], MaxTemp[t])
  }
  
  #### Priors
  x[1] ~ dnorm(x_ic,tau_ic)
  t[1] ~ dnorm(temp_ic, tempT_ic)
...
```{r}
data <- list(y=y,n=length(y), MaxTemp = MaxTemp, MinTemp = MinTemp,   ## data
             temp_ic = meanTemp, tempT_ic = stdTemp, ## initial temperature
             x_ic=0,tau_ic=0.2, ## initial condition prior
             betap=c(1,1), sigmap=diag(0.0001, 2, 2), ## setting up beta
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_45_ModelPlot.jpeg", plot = BVSModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_45_ModelErrorPlot.jpeg", plot = BVSModelErrorPlot, width = 8, height = 6)
```
...
BVSModelErrorPlot <- ggplot(BVSMod, mapping = aes(date)) +
  ...
  geom_line(aes(x = date, y = `50%`), color = "black") +
  geom_point(aes(x = date, y = BVS)) +
  annotate("text", x = as.Date("2020-01-01"), y = 25, label = "NSE = 0.995")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_ObsModelPlot_45.jpeg", plot = BVSModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_2030_45_ModelPlot.jpeg", plot = BVS_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_2030_45_ModelErrorPlot.jpeg", plot = BVS_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_2060_45_ModelPlot.jpeg", plot = BVS_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_2060_45_ModelErrorPlot.jpeg", plot = BVS_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_2090_45_ModelPlot.jpeg", plot = BVS_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/BVS_2090_45_ModelErrorPlot.jpeg", plot = BVS_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_45_ModelPlot.jpeg", plot = CABModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_45_ModelErrorPlot.jpeg", plot = CABModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_ObsModelPlot_45.jpeg", plot = CABModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_2030_45_ModelPlot.jpeg", plot = CAB_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_2030_45_ModelErrorPlot.jpeg", plot = CAB_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_2060_45_ModelPlot.jpeg", plot = CAB_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_2060_45_ModelErrorPlot.jpeg", plot = CAB_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_2090_45_ModelPlot.jpeg", plot = CAB_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAB_2090_45_ModelErrorPlot.jpeg", plot = CAB_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_45_ModelPlot.jpeg", plot = CANModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_45_ModelErrorPlot.jpeg", plot = CANModelErrorPlot, width = 8, height = 6)
```
## Getting the NSE Values
```{r}
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_ObsModelPlot_45.jpeg", plot = CANModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_2030_45_ModelPlot.jpeg", plot = CAN_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_2030_45_ModelErrorPlot.jpeg", plot = CAN_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_2060_45_ModelPlot.jpeg", plot = CAN_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_2060_45_ModelErrorPlot.jpeg", plot = CAN_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_2090_45_ModelPlot.jpeg", plot = CAN_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CAN_2090_45_ModelErrorPlot.jpeg", plot = CAN_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_45_ModelPlot.jpeg", plot = EYSModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_45_ModelErrorPlot.jpeg", plot = EYSModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_ObsModelPlot_45.jpeg", plot = EYSModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_2030_45_ModelPlot.jpeg", plot = EYS_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_2030_45_ModelErrorPlot.jpeg", plot = EYS_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_2060_45_ModelPlot.jpeg", plot = EYS_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_2060_45_ModelErrorPlot.jpeg", plot = EYS_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_2090_45_ModelPlot.jpeg", plot = EYS_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/EYS_2090_45_ModelErrorPlot.jpeg", plot = EYS_2090_ModelErrorPlot, width = 8, height = 6)
```
...
# Now you can use this data frame with ggplot2
RHM_45_ModelPlot <- ggplot(GraphDataOutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
RHM_45_ModelErrorPlot <- ggplot(GraphDataOutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
  geom_ribbon(mapping = aes(ymin = `2.5%`, ymax = `97.5%`), fill = "lightgrey") +
  geom_line(aes(x = date, y = `50%`), color = "black") +
  ...
  theme(plot.title = element_text(hjust = 0.5),
        axis.title = element_text(size = 16),
        axis.text = element_text(size = 14))
RHM_45_ModelErrorPlot

ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_45_ModelPlot.jpeg", plot = RHM_45_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_45_ModelErrorPlot.jpeg", plot = RHM_45_ModelErrorPlot, width = 8, height = 6)
```
## Getting the NSE Values
```{r}
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_ObsModelPlot_45.jpeg", plot = RHMModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_2030_45_ModelPlot.jpeg", plot = RHM_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_2030_45_ModelErrorPlot.jpeg", plot = RHM_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_2060_45_ModelPlot.jpeg", plot = RHM_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_2060_45_ModelErrorPlot.jpeg", plot = RHM_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_2090_45_ModelPlot.jpeg", plot = RHM_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/RHM_2090_45_ModelErrorPlot.jpeg", plot = RHM_2090_ModelErrorPlot, width = 8, height = 6)
```
...
# Now you can use this data frame with ggplot2
SQR_45_ModelPlot <- ggplot(GraphDataOutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
SQR_45_ModelErrorPlot <- ggplot(GraphDataOutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
  geom_ribbon(mapping = aes(ymin = `2.5%`, ymax = `97.5%`), fill = "lightgrey") +
  geom_line(aes(x = date, y = `50%`), color = "black") +
  ...
  theme(plot.title = element_text(hjust = 0.5),
        axis.title = element_text(size = 16),
        axis.text = element_text(size = 14))
SQR_45_ModelErrorPlot

ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_45_ModelPlot.jpeg", plot = SQR_45_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_45_ModelErrorPlot.jpeg", plot = SQR_45_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_ObsModelPlot_45.jpeg", plot = SQRModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_2030_45_ModelPlot.jpeg", plot = SQR_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_2030_45_ModelErrorPlot.jpeg", plot = SQR_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_2060_45_ModelPlot.jpeg", plot = SQR_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_2060_45_ModelErrorPlot.jpeg", plot = SQR_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_2090_45_ModelPlot.jpeg", plot = SQR_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/SQR_2090_45_ModelErrorPlot.jpeg", plot = SQR_2090_ModelErrorPlot, width = 8, height = 6)
```
...
# Now you can use this data frame with ggplot2
TIN_45_ModelPlot <- ggplot(GraphDataOutputCheck) +
  geom_line(aes(x = date, y = `50%`)) +
  geom_line(aes(x = date, y = `2.5%`)) +
  geom_line(aes(x = date, y = `97.5%`)) +
...
TIN_45_ModelErrorPlot <- ggplot(GraphDataOutputCheck, mapping = aes(date)) +
  geom_line(mapping = aes(y = `2.5%`)) +
  geom_line(mapping = aes(y = `97.5%`)) +
  geom_ribbon(mapping = aes(ymin = `2.5%`, ymax = `97.5%`), fill = "lightgrey") +
  geom_line(aes(x = date, y = `50%`), color = "black") +
  ...
  theme(plot.title = element_text(hjust = 0.5),
        axis.title = element_text(size = 16),
        axis.text = element_text(size = 14))
TIN_45_ModelErrorPlot

ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_45_ModelPlot.jpeg", plot = TIN_45_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_45_ModelErrorPlot.jpeg", plot = TIN_45_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_ObsModelPlot_45.jpeg", plot = TINModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_2030_45_ModelPlot.jpeg", plot = TIN_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_2030_45_ModelErrorPlot.jpeg", plot = TIN_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_2060_45_ModelPlot.jpeg", plot = TIN_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_2060_45_ModelErrorPlot.jpeg", plot = TIN_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_2090_45_ModelPlot.jpeg", plot = TIN_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIN_2090_45_ModelErrorPlot.jpeg", plot = TIN_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_45_ModelPlot.jpeg", plot = TISModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_45_ModelErrorPlot.jpeg", plot = TISModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_ObsModelPlot_45.jpeg", plot = TISModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_2030_45_ModelPlot.jpeg", plot = TIS_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_2030_45_ModelErrorPlot.jpeg", plot = TIS_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_2060_45_ModelPlot.jpeg", plot = TIS_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/IS_2060_45_ModelErrorPlot.jpeg", plot = TIS_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_2090_45_ModelPlot.jpeg", plot = TIS_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/TIS_2090_45_ModelErrorPlot.jpeg", plot = TIS_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_45_ModelPlot.jpeg", plot = WDDModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_45_ModelErrorPlot.jpeg", plot = WDDModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_ObsModelPlot_45.jpeg", plot = WDDModelErrorPlot, width = 8, height = 6)
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_2030_45_ModelPlot.jpeg", plot = WDD_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_2030_45_ModelErrorPlot.jpeg", plot = WDD_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_2060_45_ModelPlot.jpeg", plot = WDD_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_2060_45_ModelErrorPlot.jpeg", plot = WDD_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/WDD_2090_45_ModelPlot.jpeg", plot = WDD_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/DD_2090_45_ModelErrorPlot.jpeg", plot = WDD_2090_ModelErrorPlot, width = 8, height = 6)
```
...
CRD_45_Mean <- ggplot(data = monthly_stats_long, aes(x = Month, y = Mean, fill = year)) +
  ...
  geom_errorbar(aes(ymin = Mean - Std, ymax = Mean + Std), 
                position = "dodge") +
  ggtitle("Copper River Delta RCP 4.5") +
  ylim(0,30) +
  labs(fill = "Year") +
  theme_bw() +
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/CRD_45_Mean.jpeg", plot = CRD_45_Mean, width = 9, height = 6)
```

```{r}
RHM_means <- CRD_Mean_long %>%
   filter(Location == "RHM_mean")

mean(RHM_means$Mean2090_Temp)
...
```{r}
CRD_45_Mod <- data.frame(date = BVSMod_total$date)

CRD_45_Mod$BVS <- BVSMod_total$`50%`
CRD_45_Mod$CAB <- CABMod_total$`50%`
CRD_45_Mod$CAN <- CANMod_total$`50%`
CRD_45_Mod$EYS <- EYSMod_total$`50%`
CRD_45_Mod$RHM <- RHMMod_total$`50%`
CRD_45_Mod$SQR <- SQRMod_total$`50%`
CRD_45_Mod$TIN <- TINMod_total$`50%`
CRD_45_Mod$TIS <- TISMod_total$`50%`
CRD_45_Mod$WDD <- WDDMod_total$`50%`
...
IndPonds_CRD45 <- ggplot(data = meltdf, aes(x = date)) +
...
ggsave("Output/SNAP/UniformError/Plots/CopperRiver/IndPonds_CRD45.jpeg", plot = IndPonds_CRD45, width = 9, height = 6)
