...
MonthlyStatsCRD
ggsave("Output/SNAP/OriginalModel/Rerun/DeltaMonthCRD.png", plot = MonthlyStatsCRD, width = 12, height = 3)
```
...
MonthlyStatsYF
ggsave("Output/SNAP/OriginalModel/Rerun/DeltaMonthYF.png", plot = MonthlyStatsYF, width = 12, height = 3)
```
