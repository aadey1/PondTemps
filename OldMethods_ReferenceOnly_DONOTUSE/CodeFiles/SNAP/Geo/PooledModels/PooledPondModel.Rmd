...
```{r}
save.image(file = "PooledMod_CRD45.RData")
...
```{r}
load(file = "PooledMod_CRD45.RData")
```
...
str(Mod_CRD45)
write.csv(Mod_CRD45, "Mod_CRD45.csv")
...
ggsave("IndPonds_CRD45.png", plot = Ponds_CRD45, width = 8, height = 6)
...
ggsave("IndTrends_CRD45.png", plot = Trends_CRD45, width = 9, height = 6)
...
write.csv(probs_CRD45, "probs_CRD45.csv")
...
ggsave("Probs20_CRD45.png", plot = Probs20_CRD45, width = 9, height = 6)
```
...
ggsave("Error_CRD45.png", plot = ModelErrorPlot_CRD45, width = 9, height = 6)
```
...
```{r}
save.image(file = "PooledMod_CRD85.RData")
...
```{r}
load(file = "PooledMod_CRD85.RData")
```
...
str(Mod_CRD85)
write.csv(Mod_CRD85, "Mod_CRD85.csv")
...
ggsave("IndPonds_CRD85.png", plot = Ponds_CRD85, width = 8, height = 6)
...
ggsave("IndTrends_CRD85.png", plot = Trends_CRD85, width = 9, height = 6)
...
ggsave("Probs20_CRD85.png", plot = Probs20_CRD85, width = 9, height = 6)
```
...
ggsave("Error_CRD85.png", plot = ModelErrorPlot_CRD85, width = 9, height = 6)
```
...
```{r}
save.image(file = "PooledMod_YF45.RData")
...
```{r}
load(file = "PooledMod_YF45.RData")
```
...
ggsave("IndPonds_YF45.png", plot = Ponds_YF45, width = 8, height = 6)
```
...
ggsave("IndTrends_YF45.png", plot = Trends_YF45, width = 9, height = 6)
...
ggsave("Probs20_YF45.png", plot = Probs20_YF45, width = 10, height = 6)
```
...
ggsave("Error_YF45.png", plot = ErrorPlot_YF45, width = 9, height = 6)
```
...
```{r}
save.image(file = "PooledMod_YF85.RData")
...
```{r}
load(file = "PooledMod_YF85.RData")
```
...
ggsave("IndPonds_YF85.png", plot = Ponds_YF85, width = 8, height = 6)
...
ggsave("IndTrends_YF85.png", plot = Trends_YF85, width = 9, height = 6)
...
ggsave("Probs20_YF85.png", plot = Probs20_YF85, width = 9, height = 6)
```
...
ggsave("Error_YF85.png", plot = ModelErrorPlot_YF85, width = 9, height = 6)
```
