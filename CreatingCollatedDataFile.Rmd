...
# Perform the left join with subset_met3 as the left data frame
df2d <- merge(CR_subset_met3, df1c, by = "monyr", all.x = TRUE)
...
```{r}
write.csv(CR_PondAirTemp_min, file = "CR_PondAirTemp_min.csv")
write.csv(CR_PondAirTemp_max, file = "CR_PondAirTemp_max.csv")
write.csv(CR_PondAirTemp_mean, file = "CR_PondAirTemp_mean.csv")

write.csv(YF_PondAirTemp_min, file = "YF_PondAirTemp_min.csv")
write.csv(YF_PondAirTemp_max, file = "YF_PondAirTemp_max.csv")
write.csv(YF_PondAirTemp_mean, file = "YF_PondAirTemp_mean.csv")
```
