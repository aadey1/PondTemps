...
```{r}
write.csv(CR_PondAirTemp_min, file = "CR_PondAirTeimp_min")
write.csv(CR_PondAirTemp_max, file = "CR_PondAirTeimp_max")
write.csv(CR_PondAirTemp_mean, file = "CR_PondAirTeimp_mean")

write.csv(YF_PondAirTemp_min, file = "YF_PondAirTeimp_min")
write.csv(YF_PondAirTemp_max, file = "YF_PondAirTeimp_max")
write.csv(YF_PondAirTemp_mean, file = "YF_PondAirTeimp_mean")
```
