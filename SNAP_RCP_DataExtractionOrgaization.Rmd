...
write.csv(CR_45Forecast, file = "DataFiles/CR_45Forecast.csv")
...
#save this as a .csv file
write.csv(YF_45Forecast, file = "DataFiles/YF_45Forecast.csv")
...
#save this as a .csv file
write.csv(CR_85Forecast, file = "DataFiles/CR_85Forecast.csv")
...
#save this as a .csv file
write.csv(YF_85Forecast, file = "DataFiles/YF_85Forecast.csv")
...
ggsave("Plots/CR_45Temps.jpeg", plot = CR_45Temps, width = 8, height = 6)
```
...
ggsave("Plots/YF_45Temps.jpeg", plot = YF_45Temps, width = 8, height = 6)
```
...
ggsave("Plots/CR_85Temps.jpeg", plot = CR_85Temps, width = 8, height = 6)
```
...
ggsave("Plots/YF_85Temps.jpeg", plot = YF_85Temps, width = 8, height = 6)
```
