---
title: "IndividualPondModels_Forecasts45_YF"
...
```{r}
YF_Temps <- read.csv("DataFiles/YF_45SNAPForecast.csv", header=TRUE)
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_45_ModelPlot.jpeg", plot = MP1ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_45_ModelErrorPlot.jpeg", plot = MP1ModelErrorPlot, width = 8, height = 6)
```
...
write.csv(MP1Mod, file = "MP1Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_ObsModelPlot_45.jpeg", plot = MP1ModelErrorPlot, width = 8, height = 6)
...
MP1_2030_ModelPlot <- ggplot(MP1_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = MP1)) +
  ggtitle("MP1 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_2030_45_ModelPlot.jpeg", plot = MP1_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_2030_45_ModelErrorPlot.jpeg", plot = MP1_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_2060_45_ModelPlot.jpeg", plot = MP1_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_2060_45_ModelErrorPlot.jpeg", plot = MP1_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_2090_45_ModelPlot.jpeg", plot = MP1_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP1_2090_45_ModelErrorPlot.jpeg", plot = MP1_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_45_ModelPlot.jpeg", plot = MP3ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_45_ModelErrorPlot.jpeg", plot = MP3ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP3Mod <- GraphDataOutputCheck
write.csv(MP3Mod, file = "MP3Mod_45.csv", row.names = F)
...
MP3ModelErrorPlot <- ggplot(MP3Mod, mapping = aes(date)) +
  ...
  annotate("text", x = as.Date("2020-01-01"), y = 25, label = "NSE = 0.965")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_ObsModelPlot_45.jpeg", plot = MP3ModelErrorPlot, width = 8, height = 6)
...
MP3_2030_ModelPlot <- ggplot(MP3_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = MP3)) +
  ggtitle("MP3 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_2030_45_ModelPlot.jpeg", plot = MP3_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_2030_45_ModelErrorPlot.jpeg", plot = MP3_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_2060_45_ModelPlot.jpeg", plot = MP3_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_2060_45_ModelErrorPlot.jpeg", plot = MP3_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_2090_45_ModelPlot.jpeg", plot = MP3_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP3_2090_45_ModelErrorPlot.jpeg", plot = MP3_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_45_ModelPlot.jpeg", plot = MP5ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_45_ModelErrorPlot.jpeg", plot = MP5ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP5Mod <- GraphDataOutputCheck
write.csv(MP5Mod, file = "MP5Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_ObsModelPlot_45.jpeg", plot = MP5ModelErrorPlot, width = 8, height = 6)
...
MP5_2030_ModelPlot <- ggplot(MP5_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = MP5)) +
  ggtitle("MP5 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_2030_45_ModelPlot.jpeg", plot = MP5_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_2030_45_ModelErrorPlot.jpeg", plot = MP5_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_2060_45_ModelPlot.jpeg", plot = MP5_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_2060_45_ModelErrorPlot.jpeg", plot = MP5_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_2090_45_ModelPlot.jpeg", plot = MP5_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP5_2090_45_ModelErrorPlot.jpeg", plot = MP5_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_45_ModelPlot.jpeg", plot = MP8ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_45_ModelErrorPlot.jpeg", plot = MP8ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
MP8Mod <- GraphDataOutputCheck
write.csv(MP8Mod, file = "MP8Mod_45.csv", row.names = F)
...
MP8ModelErrorPlot <- ggplot(MP8Mod, mapping = aes(date)) +
  ...
  annotate("text", x = as.Date("2020-01-01"), y = 25, label = "NSE = 0.974")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_ObsModelPlot_45.jpeg", plot = MP8ModelErrorPlot, width = 8, height = 6)
...
MP8_2030_ModelPlot <- ggplot(MP8_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = MP8)) +
  ggtitle("MP8 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_2030_45_ModelPlot.jpeg", plot = MP8_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_2030_45_ModelErrorPlot.jpeg", plot = MP8_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_2060_45_ModelPlot.jpeg", plot = MP8_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_2060_45_ModelErrorPlot.jpeg", plot = MP8_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_2090_45_ModelPlot.jpeg", plot = MP8_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/MP8_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_45_ModelPlot.jpeg", plot = PL1ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_45_ModelErrorPlot.jpeg", plot = PL1ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
PL1Mod <- GraphDataOutputCheck
write.csv(PL1Mod, file = "PL1Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_ObsModelPlot_45.jpeg", plot = PL1ModelErrorPlot, width = 8, height = 6)
...
PL1_2030_ModelPlot <- ggplot(PL1_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = PL1)) +
  ggtitle("PL1 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_2030_45_ModelPlot.jpeg", plot = PL1_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_2030_45_ModelErrorPlot.jpeg", plot = PL1_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_2060_45_ModelPlot.jpeg", plot = PL1_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_2060_45_ModelErrorPlot.jpeg", plot = PL1_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_2090_45_ModelPlot.jpeg", plot = PL1_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL1_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_45_ModelPlot.jpeg", plot = PL2ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_45_ModelErrorPlot.jpeg", plot = PL2ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
PL2Mod <- GraphDataOutputCheck
write.csv(PL2Mod, file = "PL2Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_ObsModelPlot_45.jpeg", plot = PL2ModelErrorPlot, width = 8, height = 6)
...
PL2_2030_ModelPlot <- ggplot(PL2_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = PL2)) +
  ggtitle("PL2 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_2030_45_ModelPlot.jpeg", plot = PL2_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_2030_45_ModelErrorPlot.jpeg", plot = PL2_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_2060_45_ModelPlot.jpeg", plot = PL2_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_2060_45_ModelErrorPlot.jpeg", plot = PL2_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_2090_45_ModelPlot.jpeg", plot = PL2_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL2_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_45_ModelPlot.jpeg", plot = PL3ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_45_ModelErrorPlot.jpeg", plot = PL3ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
PL3Mod <- GraphDataOutputCheck
write.csv(PL3Mod, file = "PL3Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_ObsModelPlot_45.jpeg", plot = PL3ModelErrorPlot, width = 8, height = 6)
...
PL3_2030_ModelPlot <- ggplot(PL3_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = PL3)) +
  ggtitle("PL3 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_2030_45_ModelPlot.jpeg", plot = PL3_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_2030_45_ModelErrorPlot.jpeg", plot = PL3_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_2060_45_ModelPlot.jpeg", plot = PL3_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_2060_45_ModelErrorPlot.jpeg", plot = PL3_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_2090_45_ModelPlot.jpeg", plot = PL3_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/PL3_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_45_ModelPlot.jpeg", plot = UBP1ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_45_ModelErrorPlot.jpeg", plot = UBP1ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP1Mod <- GraphDataOutputCheck
write.csv(UBP1Mod, file = "UBP1Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_ObsModelPlot_45.jpeg", plot = UBP1ModelErrorPlot, width = 8, height = 6)
...
UBP1_2030_ModelPlot <- ggplot(UBP1_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = UBP1)) +
  ggtitle("UBP1 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_2030_45_ModelPlot.jpeg", plot = UBP1_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_2030_45_ModelErrorPlot.jpeg", plot = UBP1_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_2060_45_ModelPlot.jpeg", plot = UBP1_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_2060_45_ModelErrorPlot.jpeg", plot = UBP1_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_2090_45_ModelPlot.jpeg", plot = UBP1_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP1_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_45_ModelPlot.jpeg", plot = UBP2ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_45_ModelErrorPlot.jpeg", plot = UBP2ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP2Mod <- GraphDataOutputCheck
write.csv(UBP2Mod, file = "UBP2Mod_45.csv", row.names = F)
...
UBP2ModelErrorPlot <- ggplot(UBP2Mod, mapping = aes(date)) +
  ...
  annotate("text", x = as.Date("2020-01-01"), y = 25, label = "NSE = 0.963")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_ObsModelPlot_45.jpeg", plot = UBP2ModelErrorPlot, width = 8, height = 6)
...
UBP2_2030_ModelPlot <- ggplot(UBP2_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = UBP2)) +
  ggtitle("UBP2 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_2030_45_ModelPlot.jpeg", plot = UBP2_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_2030_45_ModelErrorPlot.jpeg", plot = UBP2_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_2060_45_ModelPlot.jpeg", plot = UBP2_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_2060_45_ModelErrorPlot.jpeg", plot = UBP2_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_2090_45_ModelPlot.jpeg", plot = UBP2_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP2_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_45_ModelPlot.jpeg", plot = UBP3ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_45_ModelErrorPlot.jpeg", plot = UBP3ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP3Mod <- GraphDataOutputCheck
write.csv(UBP3Mod, file = "UBP3Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_ObsModelPlot_45.jpeg", plot = UBP3ModelErrorPlot, width = 8, height = 6)
...
UBP3_2030_ModelPlot <- ggplot(UBP3_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = UBP3)) +
  ggtitle("UBP3 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_2030_45_ModelPlot.jpeg", plot = UBP3_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_2030_45_ModelErrorPlot.jpeg", plot = UBP3_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_2060_45_ModelPlot.jpeg", plot = UBP3_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_2060_45_ModelErrorPlot.jpeg", plot = UBP3_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_2090_45_ModelPlot.jpeg", plot = UBP3_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP3_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_45_ModelPlot.jpeg", plot = UBP4ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_45_ModelErrorPlot.jpeg", plot = UBP4ModelErrorPlot, width = 8, height = 6)
```

## Calculating the NSE (Nash-Sutcliffe efficiency) between our modeled/simulated values and the observations
```{r}
UBP4Mod <- GraphDataOutputCheck
write.csv(UBP4Mod, file = "UBP4Mod_45.csv", row.names = F)
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_ObsModelPlot_45.jpeg", plot = UBP4ModelErrorPlot, width = 8, height = 6)
...
UBP4_2030_ModelPlot <- ggplot(UBP4_2030) +
  ...
  geom_line(aes(x = date, y = `97.5%`)) +
  geom_point(aes(x = date, y = UBP4)) +
  ggtitle("UBP4 - Yakutat Forelands - RCP 4.5")+
  ylim(c(-10, 30))+
  ylab("Temeprature (C)") +
  xlab("Year") +
  theme_classic() +
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_2030_45_ModelPlot.jpeg", plot = UBP4_2030_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_2030_45_ModelErrorPlot.jpeg", plot = UBP4_2030_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_2060_45_ModelPlot.jpeg", plot = UBP4_2060_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_2060_45_ModelErrorPlot.jpeg", plot = UBP4_2060_ModelErrorPlot, width = 8, height = 6)
```
...
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_2090_45_ModelPlot.jpeg", plot = UBP4_2090_ModelPlot, width = 8, height = 6)
ggsave("Output/SNAP/OriginalModel/Rerun/UBP4_2090_45_ModelErrorPlot.jpeg", plot = MP8_2090_ModelErrorPlot, width = 8, height = 6)
```
...
attr(YF_45_2030, 'row.names') <- 1:nrow(MP1_2030)
...
test_long <- pivot_longer(YF_45_2030, cols = -date, names_to = "Location", values_to = "Min_Temp")
...
# pivoPL3g this longer so there is one column for mean here library(tidyr)
# Assuming your dataframe is named 'test'
test_long <- pivot_longer(YF_45_2030, cols = -date, names_to = "Location", values_to = "Mean_Temp")
...
# pivoPL3g this longer so there is one column for mean here library(tidyr)
# Assuming your dataframe is named 'test'
test_long <- pivot_longer(YF_45_2030, cols = -date, names_to = "Location", values_to = "Max_Temp")
...
YF_45_2060 <- YF_45_2030[0,]
str(YF_45_2060)


attr(YF_45_2060, 'row.names') <- 1:nrow(MP1_2060)
...
YF_45_2090 <- YF_45_2060[0,]
str(YF_45_2090)

attr(YF_45_2090, 'row.names') <- 1:nrow(MP1_2090)
...
# pivoPL3g this longer so there is one column for mean here library(tidyr)
# Assuming your dataframe is named 'test'
test_long <- pivot_longer(YF_45_2030, cols = -date, names_to = "Location", values_to = "Mean2030_Temp")
...
YF_45_2060 <- MP1_2060[0,]
str(YF_45_2060)

YF_45_2060 <- YF_45_2060 %>%
  select(date, MP1, MP3, MP5, MP8, PL1, PL2, PL3, UBP1, UBP2, UBP3, UBP4) %>%
  dplyr::rename(MP1_mean = MP1) %>%
  dplyr::rename(MP3_mean = MP3) %>%
  dplyr::rename(MP5_mean = MP5) %>%
...
attr(YF_45_2060, 'row.names') <- 1:nrow(MP1_2030)
...
# pivoPL3g this longer so there is one column for mean here library(tidyr)
# Assuming your dataframe is named 'test'
test_long <- pivot_longer(YF_45_2060, cols = -date, names_to = "Location", values_to = "Mean2060_Temp")
...
YF_45_2090 <- MP1_2090[0,]
str(YF_45_2090)

YF_45_2090 <- YF_45_2090 %>%
  select(date, MP1, MP3, MP5, MP8, PL1, PL2, PL3, UBP1, UBP2, UBP3, UBP4) %>%
  dplyr::rename(MP1_mean = MP1) %>%
  dplyr::rename(MP3_mean = MP3) %>%
  dplyr::rename(MP5_mean = MP5) %>%
...
# pivoPL3g this longer so there is one column for mean here library(tidyr)
# Assuming your dataframe is named 'test'
test_long <- pivot_longer(YF_45_2090, cols = -date, names_to = "Location", values_to = "Mean2090_Temp")
...
YF_45_Mean <- ggplot(data = monthly_stats_long, aes(x = Month, y = Mean, fill = year)) +
  geom_col(position = "dodge") +
...
ggsave("Output/SNAP/OriginalModel/Rerun/YF_45_Mean.jpeg", plot = YF_45_Mean, width = 9, height = 6)
```
...
```{r}
YF_45_Mod <- data.frame(date = MP1Mod_total$date)

YF_45_Mod$MP1 <- MP1Mod_total$`50%`
YF_45_Mod$MP3 <- MP3Mod_total$`50%`
YF_45_Mod$MP5 <- MP5Mod_total$`50%`
YF_45_Mod$MP8 <- MP8Mod_total$`50%`
YF_45_Mod$PL1 <- PL1Mod_total$`50%`
YF_45_Mod$PL2 <- PL2Mod_total$`50%`
YF_45_Mod$PL3 <- PL3Mod_total$`50%`
YF_45_Mod$UBP1 <- UBP1Mod_total$`50%`
YF_45_Mod$UBP2 <- UBP2Mod_total$`50%`
YF_45_Mod$UBP3 <- UBP3Mod_total$`50%`
YF_45_Mod$UBP4 <- UBP4Mod_total$`50%`

ggplot(data = YF_45_Mod, aes(x = date)) +
...
library(reshape)
meltdf <- melt(YF_45_Mod, id.vars ="date")
meltdf <- meltdf %>%
...
# Create the plot
IndPonds_Full_YF45 <- ggplot(data = meltdf, aes(x = date, y = value, color = Pond)) +
  geom_line(size = 0.3) +
  facet_wrap(~Pond) +
...
ggsave("Output/SNAP/OriginalModel/Rerun/IndPonds_Full_YF45.jpeg", plot = IndPonds_Full_YF45, width = 9, height = 6)
...
IndPonds_YF45 <- ggplot(data = meltdf, aes(x = date)) +
...
ggsave("Output/SNAP/OriginalModel/Rerun/IndPonds_YF45.jpeg", plot = IndPonds_YF45, width = 9, height = 6)
